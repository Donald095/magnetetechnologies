<?php include('layout/header.php');?>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                ...
                                <div class="blog-btn">
                                    <a class="blog-btn-link" href="blog-details.php">Read Full Article <i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                            </div>
                            <!-- Single Blog End -->
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">Back up your database, store in a safe</a></h3>
                                    <p>Accelerate innovation with world-class tech teams We’ll match you to an entire remote.</p>
                                </div>
                                <div class="blog-btn">
                                    <a class="blog-btn-link" href="blog-details.php">Read Full Article <i class="fas fa-long-arrow-alt-right"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-img">
                                    ...
                                    <div class="top-meta">
                                        <span class="date"><span>25</span>Aug</span>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-img">
                                    ...
                                    <div class="top-meta">
                                        <span class="date"><span>30</span>Aug</span>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
        ...
        <!-- Blog End -->
        <?php include('layout/footer-inner.php');?>